...
# Import models for radius/size experiments
...
if __name__ == "__main__":
    ...
    parser.add_argument("--radius-embedding-type", type=str, choices=["sinusoidal", "rotary", "linear", "single_linear", "raw"], default="sinusoidal",
